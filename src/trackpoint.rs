...
pub const SFACTOR_HIGH: u8 = 0x88;
pub type RST = GpioPin<Output<PushPull>, 5>;
pub type SCL = GpioPin<Output<OpenDrain>, 6>;
pub type SDA = GpioPin<Output<OpenDrain>, 7>;
...
impl TrackPoint {
    pub fn new(scl: SCL, sda: SDA, rst: RST, delay: Delay) -> Self {
        Self {
            data: DataReport {
                state: 0,
                x: 0,
